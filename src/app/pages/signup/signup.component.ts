...
export class SignupComponent {
  ...
  signup(): void {
    ...
    if (password !== rePassword) {
      this.signupError = 'A jelszók nem egyeznek.';
      return;
    }
      ...
      .catch(error => {
        ...
        switch(error.code) {
          ...
          case 'auth/weak-password':
            this.signupError = 'Gyenge jelszó. Legalább 8 karakter hosszú legyen.';
            break;
          default:
            this.signupError = 'Hiba történt a regisztráció során. Kérjük, próbálja meg később.';
        }
      });
  }
}
